<?php /*a:2:{s:64:"E:\wamp\www\adminTemplate\application\admin\view\conf\index.html";i:1529818490;s:58:"E:\wamp\www\adminTemplate\application\admin\view\base.html";i:1531224536;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
                        ...
                        <div class="flip-scroll">
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?php echo htmlentities($list['cnname']); ?></td>
                                    <td align="center"><?php echo htmlentities($list['enname']); ?></td>
                                    <td align="center">
                                        <?php if($list['type']==1): ?>
                                            单行文本
                                    ...
                                    <td align="center">
                                        <input type="number" min="0" max="255" value="<?php echo htmlentities($list['sort']); ?>" style="text-align:center;" name="<?php echo htmlentities($list['id']); ?>">
                                    </td>
                                    <td align="center">
                                ...
                                <tr>
                                    ...
                                    <td style="border:none;"></td>
                                    <td align="center">
                                        <button type="submit" class="btn btn-primary btn-sm shiny" value="排序">排序</button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
