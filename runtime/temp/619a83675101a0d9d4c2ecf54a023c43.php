<?php /*a:2:{s:66:"E:\wamp\www\adminTemplate\application\admin\view\article\edit.html";i:1531055972;s:58:"E:\wamp\www\adminTemplate\application\admin\view\base.html";i:1531224536;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="<?php echo url('update', ['id'=>app('request')->param('id')]); ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="title" placeholder="" name="title" required=""
                                               type="text" value="<?php echo htmlentities($data['title']); ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="keywords" placeholder="多个关键字使用,(逗号)隔开" name="keywords"
                                               required="" type="text" value="<?php echo htmlentities($data['keywords']); ?>">
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea class="form-control" id="des" placeholder="" name="des"
                                                  required="" style="resize:none;height:100px;font-size:2rem;"><?php echo htmlentities($data['des']); ?></textarea>
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="cid">
                                            <?php if(is_array($cateData) || $cateData instanceof \think\Collection || $cateData instanceof \think\Paginator): $i = 0; $__LIST__ = $cateData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                            <option value="<?php echo htmlentities($list['id']); ?>" <?php if($data['cid']==$list['id']): ?>selected="selected"<?php endif; ?>>
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-2 col-sm-6">
                                        ...
                                        <img src="<?php echo htmlentities($data['imgDir']); ?>/<?php echo htmlentities($data['img']); ?>" width="100px" height="100px">
                                    </div>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    ue.ready(function () {
        ue.setContent(<?php echo json_encode($data['content']); ?>);
    });
