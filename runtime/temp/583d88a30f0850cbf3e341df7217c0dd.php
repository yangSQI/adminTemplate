<?php /*a:2:{s:71:"E:\wamp\www\adminTemplate\application\admin\view\auth_group\create.html";i:1531105338;s:58:"E:\wamp\www\adminTemplate\application\admin\view\base.html";i:1531102310;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="control-group">
                                            <div class="radio">
                                                <label>
                                                    <input name="status" type="radio" class="colored-blue" value="1" checked="checked">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input name="status" type="radio" class="colored-danger" value="0">
                                        ...
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-xs-4">
                                                        <label>
                                                            <input class="checkbox-slider slider-icon yesno" type="checkbox" name="rules[]" value="<?php echo htmlentities($list['id']); ?>">
