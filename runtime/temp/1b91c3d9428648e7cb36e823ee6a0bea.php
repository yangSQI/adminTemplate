<?php /*a:2:{s:68:"E:\wamp\www\adminTemplate\application\admin\view\cate_gory\edit.html";i:1529058055;s:58:"E:\wamp\www\adminTemplate\application\admin\view\base.html";i:1531055121;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
                        ...
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="<?php echo url('update',['id'=>app('request')->param('id')]); ?>" method="post">
                                <div class="form-group">
                                    <label for="password" class="col-sm-2 control-label no-padding-right">上级栏目</label>
                                    <div class="col-sm-6">
                                        <select name="upid">
                                            <option value="0">顶级栏目</option>
                                            <?php if(is_array($cateData) || $cateData instanceof \think\Collection || $cateData instanceof \think\Paginator): $i = 0; $__LIST__ = $cateData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;if($list['level']<=$data['level'] && $list['id']!=$data['id']): ?>
                                            <option value="<?php echo htmlentities($list['id']); ?>" <?php if($data['upid']==$list['id']): ?>selected="selected"<?php endif; ?>>
                                                <?php if($list['upid']==0): ?>|--<?php endif; ?>
                                ...
                                <div class="form-group">
                                    <label for="cate_name" class="col-sm-2 control-label no-padding-right">栏目名称</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" id="cate_name" placeholder="" name="cate_name" required="" type="text" value="<?php echo htmlentities($data['cate_name']); ?>">
                                    </div>
