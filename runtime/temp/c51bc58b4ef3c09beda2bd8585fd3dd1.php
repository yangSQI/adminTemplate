                        ...
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="<?php echo url('update', ['id'=>app('request')->param('id')]); ?>" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="cnname" placeholder="" name="cnname" required="" type="text" value="<?php echo htmlentities($data['cnname']); ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="enname" placeholder="" name="enname" required="" type="text" value="<?php echo htmlentities($data['enname']); ?>">
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="type">
                                            ...
                                            <option value="1" <?php if($data['type']==1): ?>selected="selected"<?php endif; ?>>单行文本</option>
                                            <option value="2" <?php if($data['type']==2): ?>selected="selected"<?php endif; ?>>单选按钮</option>
                                            <option value="3" <?php if($data['type']==3): ?>selected="selected"<?php endif; ?>>下拉菜单</option>
                                        </select>
                                    </div>
                                    <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="value_s" placeholder="" name="value_s" type="text" value="<?php echo htmlentities($data['value_s']); ?>">
                                    </div>
