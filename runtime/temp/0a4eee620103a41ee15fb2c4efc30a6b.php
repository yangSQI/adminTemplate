<?php /*a:2:{s:64:"E:\wamp\www\adminTemplate\application\admin\view\admin\edit.html";i:1531123768;s:58:"E:\wamp\www\adminTemplate\application\admin\view\base.html";i:1531224536;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
                        ...
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="<?php echo url('update',['id'=>app('request')->param('id')]); ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="username" placeholder="" name="username" required="" type="text" value="<?php echo htmlentities($data['username']); ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="group_id" value="">
                                            ...
                                            <?php if(is_array($groupData) || $groupData instanceof \think\Collection || $groupData instanceof \think\Paginator): $i = 0; $__LIST__ = $groupData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                            <option value="<?php echo htmlentities($list['id']); ?>" <?php if($data['group_id']==$list['id']): ?>selected="selected"<?php endif; ?>><?php echo htmlentities($list['title']); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <img src="<?php echo htmlentities($data['img']); ?>" width="100px" height="100px">
                                    </div>
                                </div>
                                <div class="form-group">
