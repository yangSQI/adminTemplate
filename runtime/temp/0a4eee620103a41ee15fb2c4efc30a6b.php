<?php /*a:2:{s:64:"E:\wamp\www\adminTemplate\application\admin\view\admin\edit.html";i:1529392256;s:58:"E:\wamp\www\adminTemplate\application\admin\view\base.html";i:1529393210;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="<?php echo url('update', ['id'=>app('request')->param('id')]); ?>" enctype="multipart/form-data" method="post">
