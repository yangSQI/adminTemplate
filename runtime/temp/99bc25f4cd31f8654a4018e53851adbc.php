<?php /*a:2:{s:65:"E:\wamp\www\adminTemplate\application\admin\view\admin\index.html";i:1531122408;s:58:"E:\wamp\www\adminTemplate\application\admin\view\base.html";i:1531224536;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="page-content">
    ...
    <div class="page-body">
        ...
        <button type="button" tooltip="添加管理员" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('create'); ?>'">
                ...
                <div class="widget">
                    <div class="widget-body">
                        <div class="flip-scroll">
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php if(empty($list['title'])): ?>
                                            无
                                        <?php else: ?>
                                            <?php echo htmlentities($list['title']); endif; ?>
                                    </td>
                                    <td align="center">
                                        <img src="<?php echo htmlentities($list['img']); ?>" width="80px" height="80px">
                                    </td>
                                    <td align="center">
                            ...
                            <?php echo $data; ?>总共<?php echo htmlentities($total); ?>个管理员
                        </div>
                        <div>
                        </div>
                    </div>
